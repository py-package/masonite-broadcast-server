...
export class Cli {
    ...
    configure(yargs: any): void {
        yargs.option({
            config: {
                type: "string",
                default: "masonite-broadcast-server.json",
                    ...
                    file => {
                        console.log(
                            "Configuration file saved. Run " +
                                colors.magenta.bold(
                                    "masonite-broadcast-server start" +
                                        (file != "masonite-broadcast-server.json"
                                            ? ' --config="' + file + '"'
                                            : "")
                                ) +
                                " to run server."
    ...
    setupConfig(defaultFile) {
        return inquirer.prompt([
            ...
            },
            {
                ...
                message: "Enter the host of your Masonite authentication server."
            },
            {
                name: "protocol",
    ...
    /**
     * Start the Masonite Broadcast server.
     */
    ...
    /**
     * Stop the Masonite Broadcast server.
     */
    stop(yargs: any): void {
        yargs.option({
            config: {
